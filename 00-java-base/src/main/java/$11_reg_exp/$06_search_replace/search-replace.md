...
提示：参考[Matcher.appendReplacement()](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/regex/Matcher.html#appendReplacement(java.lang.StringBuilder%2Cjava.lang.String))方法。

[下载练习](https://liaoxuefeng.com/books/java/reg-exp/search-replace/regex-template.zip)
