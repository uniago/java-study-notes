...
![grade](https://liaoxuefeng.com/books/java/jdbc/basic/table_grade.jpg)

每个年级又有若干个班级，要把所有班级表示出来，可以在Excel中再画一个表格：

![class](https://liaoxuefeng.com/books/java/jdbc/basic/table_class.jpg)

这两个表格有个映射关系，就是根据Grade_ID可以在班级表中查找到对应的所有班级：

![grade-classes](https://liaoxuefeng.com/books/java/jdbc/basic/table_relationship.jpg)
...
![class-students](https://liaoxuefeng.com/books/java/jdbc/basic/table_relationship2.jpg)

由于本教程不涉及到关系数据库的详细内容，如果你想从零学习关系数据库和基本的SQL语句，请参考[SQL课程](https://liaoxuefeng.com/books/sql/index.html)。
