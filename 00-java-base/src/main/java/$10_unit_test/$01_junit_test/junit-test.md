...
![tdd](https://liaoxuefeng.com/books/java/unit-test/junit-test/tdd.jpg)
...
![junit-lib](https://liaoxuefeng.com/books/java/unit-test/junit-test/add-junit-lib.png)

整个项目结构如下：

![junit-test-structure](https://liaoxuefeng.com/books/java/unit-test/junit-test/junit-proj.png)
...
![junit-test-ok](https://liaoxuefeng.com/books/java/unit-test/junit-test/junit-test-pass.png)

如果测试结果与预期不符，`assertEquals()`会抛出异常，我们就会得到一个测试失败的结果：

![junit-test-failed](https://liaoxuefeng.com/books/java/unit-test/junit-test/junit-test-failed.png)
...
[下载练习](https://liaoxuefeng.com/books/java/unit-test/junit-test/junit-test.zip)
