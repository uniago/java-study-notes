...
![update-maven-project](https://liaoxuefeng.com/books/java/maven/dependency/maven-ide.png)

### 练习

使用Maven编译hello项目。

[下载练习](https://liaoxuefeng.com/books/java/maven/dependency/maven-hello.zip)
